define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.insertNodeIntoTemplate=insertNodeIntoTemplate;_exports.property$1=_exports.property=property;_exports.query$1=_exports.query=query;_exports.queryAll$1=_exports.queryAll=queryAll;_exports.removeNodesFromTemplate=removeNodesFromTemplate;_exports.templateFactory$1=_exports.templateFactory=templateFactory;_exports.supportsAdoptingStyleSheets=_exports.reparentNodes$1=_exports.reparentNodes=_exports.render$1=_exports.render$2=_exports.render=_exports.removeNodes$1=_exports.removeNodes=_exports.parts$1=_exports.parts=_exports.nothing$1=_exports.nothing=_exports.notEqual$1=_exports.notEqual=_exports.nodeMarker=_exports.noChange$1=_exports.noChange=_exports.markerRegex=_exports.marker=_exports.lastAttributeNameRegex=_exports.isTemplatePartActive$1=_exports.isTemplatePartActive=_exports.isPrimitive$1=_exports.isPrimitive=_exports.isIterable$1=_exports.isIterable=_exports.isDirective$1=_exports.isDirective=_exports.isCEPolyfill=_exports.html$2=_exports.html$1=_exports.html=_exports.eventOptions$1=_exports.eventOptions=_exports.directive$1=_exports.directive=_exports.defaultTemplateProcessor$1=_exports.defaultTemplateProcessor=_exports.defaultConverter$1=_exports.defaultConverter=_exports.customElement$1=_exports.customElement=_exports.css$1=_exports.css=_exports.createMarker$1=_exports.createMarker=_exports.boundAttributeSuffix=_exports.UpdatingElement$1=_exports.UpdatingElement=_exports.TemplateResult$3=_exports.TemplateResult$2=_exports.TemplateResult$1=_exports.TemplateResult=_exports.TemplateInstance$1=_exports.TemplateInstance=_exports.Template$1=_exports.Template=_exports.SVGTemplateResult$2=_exports.SVGTemplateResult$1=_exports.SVGTemplateResult=_exports.PropertyPart$1=_exports.PropertyPart=_exports.PropertyCommitter$1=_exports.PropertyCommitter=_exports.NodePart$1=_exports.NodePart=_exports.LitElement=_exports.EventPart$1=_exports.EventPart=_exports.DefaultTemplateProcessor$1=_exports.DefaultTemplateProcessor=_exports.CSSResult$1=_exports.CSSResult=_exports.BooleanAttributePart$1=_exports.BooleanAttributePart=_exports.AttributePart$1=_exports.AttributePart=_exports.AttributeCommitter$1=_exports.AttributeCommitter=_exports.$updatingElement=_exports.$templateResult=_exports.$templateInstance=_exports.$templateFactory=_exports.$template=_exports.$tamaClickDefault=_exports.$tamaClick=_exports.$shadyRender=_exports.$render=_exports.$parts=_exports.$part=_exports.$modifyTemplate=_exports.$litHtml=_exports.$litElement=_exports.$eventDispatcherDefault=_exports.$eventDispatcher=_exports.$dom=_exports.$directive=_exports.$defaultTemplateProcessor=_exports.$decorators=_exports.$cssTag=void 0;_exports.unsafeCSS$1=_exports.unsafeCSS=_exports.templateCaches$1=_exports.templateCaches=_exports.svg$2=_exports.svg$1=_exports.svg=_exports.supportsAdoptingStyleSheets$1=void 0;function _templateObject2_a54107b0094411eab24e23640da89079(){var data=babelHelpers.taggedTemplateLiteral(["\n            #slot-wrapper{\n                padding-left: 0;\n                padding-right: 0;\n                margin-left: auto;\n                margin-right: auto;\n                display: block;\n                }\n            "]);_templateObject2_a54107b0094411eab24e23640da89079=function _templateObject2_a54107b0094411eab24e23640da89079(){return data};return data}function _templateObject_a54107b0094411eab24e23640da89079(){var data=babelHelpers.taggedTemplateLiteral(["\n            <div id=\"slot-wrapper\">\n                <slot></slot>\n            </div>\n        "]);_templateObject_a54107b0094411eab24e23640da89079=function _templateObject_a54107b0094411eab24e23640da89079(){return data};return data}/**
@license
...
// expecting arrays
// tslint:disable-next-line:no-any
this._instanceProperties.forEach(function(v,p){return _this4[p]=v});this._instanceProperties=void 0}},{key:"connectedCallback",value:function connectedCallback(){this._updateState=this._updateState|STATE_HAS_CONNECTED;// Ensure first connection completes an update. Updates cannot complete
...
this._markUpdated()}if(shouldUpdate){if(!(this._updateState&STATE_HAS_UPDATED)){this._updateState=this._updateState|STATE_HAS_UPDATED;this.firstUpdated(changedProperties)}this.updated(changedProperties)}}},{key:"_markUpdated",value:function _markUpdated(){this._changedProperties=new Map;this._updateState=this._updateState&~STATE_UPDATE_REQUESTED}/**
     ...
     *
     * * @param _changedProperties Map of changed properties with old values
     */},{key:"update",value:function update(_changedProperties){var _this6=this;if(this._reflectingProperties!==void 0&&0<this._reflectingProperties.size){// Use forEach so this works even if for/of loops are compiled to for
// loops expecting arrays
this._reflectingProperties.forEach(function(v,k){return _this6._propertyToAttribute(k,_this6[k],v)});this._reflectingProperties=void 0}}/**
...
var superProperties=Object.getPrototypeOf(this)._classProperties;if(superProperties!==void 0){superProperties.forEach(function(v,k){return _this7._classProperties.set(k,v)})}}}/**
...
// expecting arrays
this._classProperties.forEach(function(v,p){var attr=_this8._attributeNameForProperty(p,v);if(attr!==void 0){_this8._attributeToPropertyMap.set(attr,p);attributes.push(attr)}});return attributes}}]);return UpdatingElement}(babelHelpers.wrapNativeSuper(HTMLElement));_exports.UpdatingElement$1=_exports.UpdatingElement=UpdatingElement;_a=finalized;/**
...
styleSet.forEach(function(v){return styles.unshift(v)})}else if(userStyles){styles.push(userStyles)}return styles}}]);return LitElement}(UpdatingElement);_exports.LitElement=LitElement;/**
   ...
   */LitElement.finalized=!0;/**
                                 ...
                                 * @nocollapse
                                 */LitElement.render=render$2;var litElement={LitElement:LitElement,defaultConverter:defaultConverter,notEqual:notEqual,UpdatingElement:UpdatingElement,customElement:customElement,property:property,query:query,queryAll:queryAll,eventOptions:eventOptions,html:html,svg:svg,TemplateResult:TemplateResult,SVGTemplateResult:SVGTemplateResult,supportsAdoptingStyleSheets:supportsAdoptingStyleSheets,CSSResult:CSSResult,unsafeCSS:unsafeCSS,css:css};_exports.$litElement=litElement;var EventDispatcher=/*#__PURE__*/function(_Phaser$Events$EventE){babelHelpers.inherits(EventDispatcher,_Phaser$Events$EventE);function EventDispatcher(){babelHelpers.classCallCheck(this,EventDispatcher);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(EventDispatcher).apply(this,arguments))}return EventDispatcher}(Phaser.Events.EventEmitter),eventDispatcher=new EventDispatcher;_exports.$eventDispatcherDefault=eventDispatcher;var eventDispatcher$1={default:eventDispatcher};_exports.$eventDispatcher=eventDispatcher$1;var TamaClick=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(TamaClick,_LitElement);function TamaClick(){var _this12;babelHelpers.classCallCheck(this,TamaClick);_this12=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(TamaClick).call(this));var _this=babelHelpers.assertThisInitialized(_this12);window.addEventListener("beforeinstallprompt",function(e){e.preventDefault();return;_this._deferredPrompt=e;eventDispatcher.emit("beforeinstallprompt")});eventDispatcher.on("bootSceneCreate",_this12._onBootSceneCreate,babelHelpers.assertThisInitialized(_this12));_this12._config={type:Phaser.AUTO,parent:TamaClick.is,width:640,height:1136,pixelArt:!0,physics:{default:"arcade",arcade:{gravity:{y:300},debug:!1}},scene:[BootScene,WorldScene]};_this12._game=new Phaser.Game(_this12._config);console.clear();console.log("201911141741");return _this12}babelHelpers.createClass(TamaClick,[{key:"render",value:function render(){return html(_templateObject_a54107b0094411eab24e23640da89079())}},{key:"_onInstallButtonClick",value:function _onInstallButtonClick(){var _this13=this;this._deferredPrompt.prompt();this._deferredPrompt.userChoice.then(function(cr){if("accepted"===cr.outcome){_this13._deferredPrompt=null}})}},{key:"_onBootSceneCreate",value:function _onBootSceneCreate(){var _this14=this,slotWrapper=this.shadowRoot.querySelector("#slot-wrapper"),canvas=document.querySelector("canvas");window.addEventListener("resize",function(){return _this14._resizeApp(slotWrapper,canvas)});this._resizeApp(slotWrapper,canvas)}},{key:"_resizeApp",value:function _resizeApp(slotWrapper,canvas){var game_ratio=this._config.width/this._config.height;slotWrapper.style.width=window.innerHeight*game_ratio+"px";slotWrapper.style.height=window.innerHeight+"px";var dpi_w=parseInt(slotWrapper.style.width)/canvas.width,dpi_h=parseInt(slotWrapper.style.height)/canvas.height,height=window.innerHeight*(dpi_w/dpi_h),width=height*game_ratio;canvas.style.width=width+"px";canvas.style.height=height+"px"}}],[{key:"is",get:function get(){return"tama-click"}},{key:"styles",get:function get(){return[css(_templateObject2_a54107b0094411eab24e23640da89079())]}},{key:"properties",get:function get(){return{_game:Object,_config:Object,_deferredPrompt:Object}}}]);return TamaClick}(LitElement);_exports.$tamaClickDefault=TamaClick;var BootScene=/*#__PURE__*/function(_Phaser$Scene){babelHelpers.inherits(BootScene,_Phaser$Scene);function BootScene(){babelHelpers.classCallCheck(this,BootScene);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(BootScene).call(this,{key:"BootScene",active:!0}))}babelHelpers.createClass(BootScene,[{key:"preload",value:function preload(){var basePath=document.querySelector("base").getAttribute("href");this.load.image("background","".concat(basePath,"src/assets/tama-click/background.png"));this.load.spritesheet("sprite_wind_0","/src/assets/tama-click/sprite_wind_0.png",{frameWidth:640,frameHeight:102});this.load.spritesheet("sprite_gras_0","/src/assets/tama-click/sprite_gras_0.png",{frameWidth:640,frameHeight:20});this.load.spritesheet("sprite_gras_1","/src/assets/tama-click/sprite_gras_1.png",{frameWidth:640,frameHeight:20});for(var i=0;12>i;++i){this.load.spritesheet("fire_stage_".concat(i),"".concat(basePath,"src/assets/tama-click/levels/0/stages/fire_stage_").concat(i,".png"),{frameWidth:320,frameHeight:350})}this.load.spritesheet("fire_stage_12","/src/assets/tama-click/levels/0/stages/fire_stage_12.png",{frameWidth:64,frameHeight:44});this.load.spritesheet("earth_goodie_0","".concat(basePath,"src/assets/tama-click/goodies/earth_goodie_0.png"),{frameWidth:60,frameHeight:60});this.load.spritesheet("fire_goodie_0","".concat(basePath,"src/assets/tama-click/goodies/fire_goodie_0.png"),{frameWidth:60,frameHeight:60});this.load.spritesheet("water_goodie_0","".concat(basePath,"src/assets/tama-click/goodies/water_goodie_0.png"),{frameWidth:60,frameHeight:60})}},{key:"create",value:function create(){this.anims.create({key:"sprite_wind_0",frames:this.anims.generateFrameNumbers("sprite_wind_0",{start:0,end:15}),frameRate:.5,repeat:-1});this.anims.create({key:"sprite_gras_0",frames:this.anims.generateFrameNumbers("sprite_gras_0",{start:0,end:4}),frameRate:10,repeat:-1});this.anims.create({key:"sprite_gras_1",frames:this.anims.generateFrameNumbers("sprite_gras_1",{start:0,end:4}),frameRate:5,repeat:-1});for(var i=0;12>i;++i){this.anims.create({key:"fire_stage_".concat(i),frames:this.anims.generateFrameNumbers("fire_stage_".concat(i),{start:0,end:4}),frameRate:30,repeat:0})}this.anims.create({key:"earth_goodie_0",frames:this.anims.generateFrameNumbers("earth_goodie_0",{start:0,end:4}),frameRate:10,repeat:0});this.anims.create({key:"fire_goodie_0",frames:this.anims.generateFrameNumbers("fire_goodie_0",{start:0,end:4}),frameRate:10,repeat:0});this.anims.create({key:"water_goodie_0",frames:this.anims.generateFrameNumbers("water_goodie_0",{start:0,end:4}),frameRate:10,repeat:0});this.anims.create({key:"fire_stage_12",frames:this.anims.generateFrameNumbers("fire_stage_12",{start:0,end:4}),frameRate:10,repeat:0});eventDispatcher.emit("bootSceneCreate");this.scene.start("WorldScene")}}]);return BootScene}(Phaser.Scene),WorldScene=/*#__PURE__*/function(_Phaser$Scene2){babelHelpers.inherits(WorldScene,_Phaser$Scene2);function WorldScene(){var _this15;babelHelpers.classCallCheck(this,WorldScene);_this15=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(WorldScene).call(this,{key:"WorldScene"}));_this15._clicks=0;_this15._points=0;_this15._tamas=void 0;_this15._score=0;_this15._goodiePoints=0;_this15._goodies=void 0;_this15._goodieArray=[];_this15._storedScores=0;_this15._bottomText=void 0;_this15._goodiePointsText=void 0;_this15._cps=0;_this15._cpsText=void 0;function isPrime(num){for(var i=2;i<num;i++){if(0===num%i){return!1}}return!0}for(var iteration=5,i=3;1e3>i;i+=2){if(isPrime(i)){--iteration;if(0===iteration){_this15._goodieArray.push(i);iteration=5}}}return _this15}babelHelpers.createClass(WorldScene,[{key:"create",value:function create(){this.add.image(0,0,"background").setOrigin(0,0);this._sprite_wind_0=this.add.sprite(0,0,"sprite_wind_0").setOrigin(0,0);this._sprite_wind_0.play("sprite_wind_0");this._gras_0=this.add.sprite(0,807,"sprite_gras_0").setOrigin(0,0);this._gras_0.play("sprite_gras_0");this._gras_1=this.add.sprite(0,713,"sprite_gras_1").setOrigin(0,0);this._gras_1.play("sprite_gras_1");this.dsa=this.add.sprite(160,500,"fire_stage_0").setOrigin(0,0);this.dsa.dsaId="fire_stage_0";this.dsa.isClickArea=!0;this.dsa.setInteractive();// this._cpsText = this.add.text(0, 150, 'CPS: 0', {
//     fontSize: '25px',
//     fill: '#fff',
// });
this._bottomText=this.add.text(0,933,"Tama Click",{fontSize:"83px",fill:"#fff",align:"center",fixedWidth:640});this._scoreText=this.add.text(0,993,"0",{fontSize:"60px",fill:"#fff",align:"center",fixedWidth:640});this._goodiePointsText=this.add.text(0,1053,"0",{fontSize:"60px",fill:"#fff",align:"center",fixedWidth:640});this._goodies=this.physics.add.group();this._tamas=this.physics.add.group();var _this=this,lastClickPoints=this._score;setInterval(function(){_this._cps=_this._score-lastClickPoints;//_this._cpsText.setText('CPS: ' + _this._cps);
lastClickPoints=_this._score;// if (_this._score > _this._storedScores) {
//     --_this._score;
//     _this._scoreText.setText(_this._score);
// }
},1e3);var asdScore=0;setInterval(function(){if(0<_this._clicks){--_this._clicks;++_this._points;_this._bottomText.setText(_this._points);_this._scoreText.setText(_this._clicks);_this.dsa.play(_this.dsa.dsaId);_this._updateScore(1)}},250);this.input.on("gameobjectdown",this._onObjectClicked);eventDispatcher.on("beforeinstallprompt",this._enableInstallButton,this)}},{key:"_enableInstallButton",value:function _enableInstallButton(){this._installButton.setInteractive()}},{key:"_updateScore",value:function _updateScore(points){for(var i=0;i<points;++i){++this._score;//this._scoreText.setText(this._score);
if(3===this._score){this._storedScores=this._score;this._initStage("fire_stage_1")}else if(6===this._score){this._storedScores=this._score;this._initStage("fire_stage_2")}else if(10===this._score){this._storedScores=this._score;this._initStage("fire_stage_3")}else if(20===this._score){this._storedScores=this._score;this._initStage("fire_stage_4")}else if(30===this._score){this._storedScores=this._score;this._initStage("fire_stage_5")}else if(40===this._score){this._storedScores=this._score;this._initStage("fire_stage_6")}else if(50===this._score){this._storedScores=this._score;this._initStage("fire_stage_7")}else if(60===this._score){this._storedScores=this._score;this._initStage("fire_stage_8")}else if(70===this._score){this._storedScores=this._score;this._initStage("fire_stage_9")}else if(80===this._score){this._storedScores=this._score;this._initStage("fire_stage_10")}else if(90===this._score){this._storedScores=this._score;this._initStage("fire_stage_11")}else if(100===this._score){this._score=0;this._initStage("fire_stage_0");var tama=this._tamas.create(60,60,"fire_stage_12");tama.tamaLife=100;tama.setBounce(.2);tama.setCollideWorldBounds(!0);//goodie.setVelocity(Phaser.Math.Between(-200, 200), 20);
this.physics.add.collider(tama,this._tamas,this._onTamaCollid,null,this);this.physics.add.collider(tama,this._goodies,this._onGoodieCollid,null,this)}if(this._goodieArray.includes(this._score)){var indexOfI=this._goodieArray.indexOf(this._score);this._goodieArray[indexOfI]=0;switch(Math.floor(3*Math.random())){case 0:this._createGoodie("earth_goodie_0",10);break;case 1:this._createGoodie("fire_goodie_0",15);break;case 2:this._createGoodie("water_goodie_0",20);break;default:break;}}}}},{key:"_onTamaCollid",value:function _onTamaCollid(tama,t2){var tamaA=tama,tamaB=t2;//console.log(tamaA.y)
if(500>tamaA.y)return;if(tamaA.x>tamaB.x){tamaA.setVelocity(250,-250);tamaB.setVelocity(-250,-250)}else{tamaA.setVelocity(-250,-250);tamaB.setVelocity(250,-250)}tamaA.play("fire_stage_12");tamaB.play("fire_stage_12");//tamaB.setVelocity(-250);
//tamaA.setVelocity(-50);
return;//var asd = {};
var asd={blocked:tamaA.body.blocked,touching:tamaA.body.touching,embedded:tamaA.body.embedded};if(asd.touching.up&&!1===tamaA.jumping){tamaA.jumping=!0;tamaA.setVelocity(-50)}else{tamaA.jumping=!0}return;console.log(asd);//console.log(tamaB.body);
if(tamaA.x>tamaB.x){console.log("tama a is Left",tamaA.x<tamaB.x);tamaA.setVelocity(-250);//tamaA.setVelocity(-250);
//tamaA.destroy();
return}//tamaA.setVelocity(250);
return;console.log("asd");tamaB.setVelocity(-250);return;//console.log('tamaB.x', tamaB.x);
if(0<tamaA.life){}else{}if(0<tama.tamaLife){tama.setVelocity(1e3,-500);tama.play("fire_stage_12");t2.setVelocity(-1e3,-250);t2.play("fire_stage_12");if(.5<Math.random()){// tama.setVelocityY(-500);
// tama.setVelocityX(-250);
}else{// tama.setVelocityY(500);
// tama.setVelocityX(-250);
}--tama.tamaLife;//console.log('tamaJump', tama.tamaLife);
}else{//console.log('destroy', tama.tamaLife);
tama.destroy()}}},{key:"_onGoodieCollid",value:function _onGoodieCollid(tama,goodie){tama.tamaLife=tama.tamaLife+10;tama.play("fire_stage_12");goodie.destroy()}},{key:"_updateGoodiePoints",value:function _updateGoodiePoints(points){for(var i=0;i<points;++i){++this._goodiePoints;this._goodiePointsText.setText(this._goodiePoints)}}},{key:"_createGoodie",value:function _createGoodie(goodieId,points){var goodie=this._goodies.create(60,60,goodieId);goodie.isGoodie=!0;goodie.points=points;goodie.goodieId=goodieId;goodie.allowGravity=!1;goodie.setBounce(1);goodie.setCollideWorldBounds(!0);goodie.setVelocity(Phaser.Math.Between(-200,200),20);goodie.setInteractive()}},{key:"_onObjectClicked",value:function _onObjectClicked(pointer,gameObject){if(gameObject.isClickArea){++this.scene._clicks;// gameObject.play(gameObject.dsaId);
//this.scene._updateScore(1);
}else if(gameObject.isGoodie){this.scene._onGoodieClick(gameObject)}if(gameObject.texture){switch(gameObject.texture.key){default:break;}}}},{key:"_onGoodieClick",value:function _onGoodieClick(goodie){goodie.isGoodie=!1;goodie.play(goodie.goodieId).on("animationcomplete",function(){return goodie.disableBody(!0,!0)});this._clicks=this._clicks+goodie.points;this._updateGoodiePoints(1);// this._updateScore(goodie.points);
}},{key:"_initStage",value:function _initStage(stageId){// this._goodies.children.entries.forEach(x => {
//     if (x.active) {
//         x.isGoodie = false;
//         x.play(x.goodieId);
//         x.on('animationcomplete', () => x.disableBody(true, true));
//     }
// });
this.dsa.destroy();this.dsa=this.add.sprite(160,500,stageId).setOrigin(0,0);this.dsa.dsaId=stageId;this.dsa.isClickArea=!0;this.dsa.setInteractive()}}]);return WorldScene}(Phaser.Scene);window.customElements.define(TamaClick.is,TamaClick);var tamaClick={default:TamaClick};_exports.$tamaClick=tamaClick});